...
robotpy-installer download-opkg python36-robotpy-ctre python36-robotpy-cscore mjpg-streamer

robotpy-installer install-robotpy
robotpy-installer install-opkg python36-robotpy-ctre python36-robotpy-cscore mjpg-streamer
